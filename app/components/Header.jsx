    ...
    return (
        <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col justify-center items-center gap-4'>
            ...
            <motion.h3
                ...
                Hi! I'm Swaraj Harode <Image src={assets.hand_icon} alt='' className='w-6' />
            </motion.h3>
            ...
            <motion.p
                ...
                I create modern and responsive websites that help businessgtes establish a strong online presence and engage their audience effectively.
            </motion.p>
            ...
            <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
                ...
                <motion.a
                    ...
                    href="/swaraj-resume.pdf" download className='px-10 py-3 border rounded-full border-gray-500 flex items-center gap-2 dark:bg-white dark:text-black'>
